...
function localStratergies(Users, Admin, _passport, localStratergy, jwt) {
    ...
    new localStratergy(
      ...
      (req, username, password, done) => {
        process.nextTick(() => {
          ...
          if (fetchedToken) {
            jwt.verify(fetchedToken, envConfig.secret, (err, decodedToken) => {
              if (err) throw err;
        ...
        process.nextTick(() => {
          Users.findOne({ "local.email": username }, (err, user) => {
            ...
            if (user) {
              ...
              user.local.subscribed = req.body.a_subscribed || false;
...
function googleOAuth20Stratergy(
  req,
  Users,
  _passport,
...
function facebookOAuth20Stratergy(
  req,
  Users,
  _passport,
...
// export the module
module.exports = {
  localStratergies: localStratergies,
  googleOAuth20Stratergy: googleOAuth20Stratergy,
  facebookOAuth20Stratergy: facebookOAuth20Stratergy
};
